    ...
    function jogar() {
        baralho.push({ carta: "A", numCarta: 1, naipe: "Ouros", numNaipe: 1, valor: 1 },
            ...
            { carta: "Valete", numCarta: 8, naipe: "Ouros", numNaipe: 1, valor: 0.5 },
            { carta: "Valete", numCarta: 8, naipe: "Espadas", numNaipe: 2, valor: 0.5 },
            { carta: "Valete", numCarta: 8, naipe: "Copas", numNaipe: 3, valor: 0.5 },
            { carta: "Valete", numCarta: 8, naipe: "Paus", numNaipe: 4, valor: 0.5 },
            { carta: "Rainha", numCarta: 9, naipe: "Ouros", numNaipe: 1, valor: 0.5 },
            { carta: "Rainha", numCarta: 9, naipe: "Espadas", numNaipe: 2, valor: 0.5 },
            { carta: "Rainha", numCarta: 9, naipe: "Copas", numNaipe: 3, valor: 0.5 },
            { carta: "Rainha", numCarta: 9, naipe: "Paus", numNaipe: 4, valor: 0.5 },
            { carta: "Rei", numCarta: 10, naipe: "Ouros", numNaipe: 1, valor: 0.5 },
            { carta: "Rei", numCarta: 10, naipe: "Espadas", numNaipe: 2, valor: 0.5 },
            { carta: "Rei", numCarta: 10, naipe: "Copas", numNaipe: 3, valor: 0.5 },
            { carta: "Rei", numCarta: 10, naipe: "Paus", numNaipe: 4, valor: 0.5 })
    ...
    for (; somaBanca <= somaJogador;) {
        for (let index = 0; index < baralho.length; index++) {
            ...
            let naipe = (Math.random() * 4 + 1).toFixed(0);
            let cartaAtual = { carta: num, naipe: naipe };
            let cartaJaPuxada = false;
    ...
    if (somaBanca == 7.5) {
        ...
        divBanca.innerHTML += `<br>BANCA ESTOUROU!`;
